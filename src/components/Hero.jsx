      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 z-10 text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/35 backdrop-blur-md shadow-sm">
              <span className="w-2 h-2 rounded-full bg-[#FDE68A] animate-pulse" />
              <span className="text-xs font-bold font-mono tracking-widest text-[#FDE68A] uppercase">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight font-poppins leading-[1.12] text-white">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
              ...
              <Button
                ...
                className="px-6 py-3.5 font-poppins font-semibold text-sm text-slate-200 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-6 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-xs text-slate-300 font-medium">CCPA 2022 Statutory Protection</span>
              </div>
              <div className="flex items-center gap-2.5">
                <CheckCircle2 size={16} className="text-[#D4AF37] shrink-0" />
                <span className="text-xs text-slate-300 font-medium">Deterministic 5% GST Verification</span>
              </div>
              <div className="flex items-center gap-2.5">
                <CheckCircle2 size={16} className="text-[#38BDF8] shrink-0" />
                <span className="text-xs text-slate-300 font-medium">Automated Legal Dispute Memos</span>
              </div>
            </div>
