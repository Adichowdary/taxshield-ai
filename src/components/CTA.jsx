  ...
  return (
    <section className="py-20 md:py-28 relative cta-section-bg">
      ...
      <Container>
        ...
        >
          <div className="p-10 md:p-16 text-center relative overflow-hidden rounded-3xl cta-card-bg">
            {/* Specular top accent */}
            ...
            {/* Ambient glow layers */}
            <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-sky-500/10 dark:bg-[#D4AF37]/10 blur-[100px] pointer-events-none" />
            ...
            <div className="relative z-10 space-y-6">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-poppins font-extrabold leading-[1.1] tracking-tight text-slate-900 dark:text-white">
                Hand us the invoice.{' '}
              ...
              <p className="text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-sans text-slate-700 dark:text-slate-300">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Button 
                  ...
                  size="lg" 
                  to="/dashboard" 
                  className="w-full sm:w-auto px-10 font-bold shadow-lg shadow-sky-500/25 dark:shadow-[0_0_40px_rgba(212,175,55,0.4)] border-glow-animated"
                >
                ...
                <Button 
                  ...
                  className="w-full sm:w-auto font-semibold px-10 vault-glass border border-slate-200 dark:border-white/15 hover:border-sky-500/50 dark:hover:border-[#D4AF37]/50"
                >
                  Learn How It Works
                </Button>
              </div>
